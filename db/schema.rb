...
ActiveRecord::Schema[7.0].define(version: 2023_12_12_073045) do
  ...
  create_table "mathilda_classes_teachers", id: false, force: :cascade do |t|
    ...
    t.index ["mathilda_class_id", "teacher_id"], name: "index_mathilda_classes_teachers"
    t.index ["teacher_id", "mathilda_class_id"], name: "index_teachers_mathilda_classes"
  end
